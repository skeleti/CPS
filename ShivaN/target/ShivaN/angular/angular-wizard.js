...
angular.module("wizard.html", []).run(["$templateCache",
    function($templateCache) {
...
angular.module('mgo-angular-wizard').directive('wizard', function() {
    return {
        ...
        controller: ['$scope', '$element', 'WizardHandler',
            function($scope, $element, WizardHandler) {
                ...
                $scope.goTo = function(step) {
                    ...
                    $scope.$emit('wizard:stepChanged', {
                        step: step,
                        index: _.indexOf($scope.getEnabledSteps(), step)
                    });
                };
                ...
                this.goTo = function(step) {
                    ...
                    if (_.isNumber(step)) {
                        ...
                        stepTo = _.findWhere(enabledSteps, {
                            title: step
                        });
                    }
                    $scope.goTo(stepTo);
