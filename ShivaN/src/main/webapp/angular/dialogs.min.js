! function() {
    ...
    var n;
    try {
        angular.module("pascalprecht.translate"), console.log("Dialogs (Angular-Translate): OK"), n = angular.module("dialogs.controllers", ["ui.bootstrap.modal", "pascalprecht.translate"])
    } catch (e) {
        console.log("Dialogs: (Angular-Translate): " + e.message), console.log("Dialogs: Attempting to use translate.sub module."), n = angular.module("dialogs.controllers", ["ui.bootstrap.modal", "translate.sub"])
    }
    n.controller("errorDialogCtrl", ["$scope", "$modalInstance", "$translate", "data", function(a, n, e, s) {
    ...
    }]), n.controller("waitDialogCtrl", ["$scope", "$modalInstance", "$translate", "$timeout", "data", function(a, n, e, s, o) {
        ...
        var a = !0,
            ...
            r = function(s) {
                var o = {};
                return s = s || {}, o.kb = angular.isDefined(s.keyboard) ? s.keyboard : n, o.bd = angular.isDefined(s.backdrop) ? s.backdrop : a, o.ws = angular.isDefined(s.size) && (angular.equals(s.size, "sm") || angular.equals(s.size, "lg") || angular.equals(s.size, "md")) ? s.size : l, o.wc = angular.isDefined(s.windowClass) ? s.windowClass : e, o
            };
        this.useBackdrop = function(n) {
            ...
            return {
                ...
                create: function(n, e, o, l) {
                    var t = l && angular.isDefined(l.copy) ? l.copy : s;
                    return l = r(l), a.open({
                        templateUrl: n,
                        controller: e,
                        keyboard: l.kb,
        ...
        try {
            ...
            console.log("Dialogs: Creating default translations for use without Angular-Translate."), a.translations("en-US", {
                DIALOGS_ERROR: "Error",
                DIALOGS_ERROR_MSG: "An unknown error has occurred.",
                DIALOGS_CLOSE: "Close",
                DIALOGS_PLEASE_WAIT: "Please Wait",
                DIALOGS_PLEASE_WAIT_ELIPS: "Please Wait...",
                DIALOGS_PLEASE_WAIT_MSG: "Waiting for operation to complete.",
        ...
        try {
            ...
            angular.forEach(s, function(a) {
                var e = null;
                angular.equals(a.href, null) || (e = a.href.match(/font\-*awesome/)), !a.disabled && angular.isArray(e) && (console.log("Dialogs: Using Font-Awesome Icons"), n.useFontAwesome())
            })
        } catch (e) {
